// Package worker implements a MapReduce worker using a WebSocket client.
package worker
...
// Worker is an active map or reduce worker client.
// It handles its assigned job, and incoming/outgoing messages to the client.
//
...
type Worker interface {
	...
	// job expiration TTL goroutines, and closing the websocket connection.
	Close()
}
